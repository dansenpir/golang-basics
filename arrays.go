...
func main() {
	utils.PrintSection("1. Declaring and Initializing Arrays")
	var numbers [5]int
	numbers[0] = 10
	numbers[1] = 20
	numbers[2] = 30
	...
	utils.PrintSection("6. Array Comparison")
	arr1 := [3]int{1, 2, 3}
	arr2 := [3]int{1, 2, 3}
	arr3 := [3]int{3, 2, 1}
	...
	utils.PrintSection("7. Copying Arrays")
